...
function Home() {
  ...
  const postData = async (e) => {
    ...
    const res = await fetch(
      "https://reactsignuppage-default-rtdb.firebaseio.com/reactsignuppage.json",
      {
        method: "POST",
        headers: {
        ...
        <div className=" flex justify-center items-center h-[96] w-[20vw] max-md:w-72 max-md:h-auto bg-zinc-200 rounded-2xl">
          <form action="" method="POST">
            <div className="flex justify-center items-center mt-4">
              <h1 className="text-3xl uppercase text-red-500 font-extrabold">
                Sign Up
              </h1>
            </div>
            <div className="mt-3">
            ...
            <div className="flex justify-center items-center mt-2">
              <button
                className="bg-red-500 mt-4 px-4 py-1.5 text-white rounded-lg font-bold text-lg border-r-2"
                onClick={postData}
              >
                Sign Up
              </button>
            ...
            <div className="mt-2">
              <h1 className="flex justify-center items-center font-semibold uppercase text-xl">
                Or
              </h1>
            ...
            <div className="flex -ml-4 mt-3 mb-4">
              ...
              <div className="text-sm font-semibold px-2 mb-2">
                <button className="uppercase text-md font-bold text-red-500 hover:text-red-700 duration-300">
                  <Link to={"/Two"}>Sign In</Link>
                </button>
              </div>
            </div>
          </form>
